...
namespace GymTracker.Infra.Migrations
{
    ...
    [Migration("20240608032508_ProfileUpdatedOnColumnAddedToUsersTable")]
    partial class ProfileUpdatedOnColumnAddedToUsersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymTracker.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("ProfileUpdatedOn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("profile_updated_on");
            ...
            modelBuilder.Entity("GymTracker.Domain.Entities.DiaryExerciseSerie", b =>
                {
                    b.HasOne("GymTracker.Domain.Entities.DiaryExercise", "DiaryExercise")
                        .WithMany()
                        .HasForeignKey("DiaryExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DiaryExercise");
                });
